...
import getAllCustomers from '@salesforce/apex/courseraLwcController.getAllCustomers';
...
export default class CourseraHeader extends LightningElement {
    ...
    handleSearchClick(event){
        if(this.isEmptyOrSpaces(this.searchKey)){
            this.dispatchEvent(new ShowToastEvent({ message: 'Please Enter something to Search!', variant: 'error'}));
            return;
        }
